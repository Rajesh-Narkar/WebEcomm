...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="card-body">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebEcomConnectionString3 %>" ProviderName="<%$ ConnectionStrings:WebEcomConnectionString3.ProviderName %>" SelectCommand="SELECT * FROM [Product]"></asp:SqlDataSource>
    </div>
